	     ...
	     <div role="navigation" class="navbar-collapse collapse">
	          ...
	          <ul class="nav navbar-nav" id="topMenu">
				...
				<li class="dropdown ${(index==2)?string('active','')}">
					...
					<ul class="dropdown-menu">
						<@shiro.hasPermission name="/member/list.shtmlno">
							<li><a href="${basePath}/member/list.shtml">用户列表</a></li>
						</@shiro.hasPermission>
						<@shiro.hasPermission name="/member/online.shtmlno">
				...
				<@shiro.hasAnyRoles name='888888,100004'>
					<li class="dropdown ${(index==3)?string('active','')}">
						...
						<ul class="dropdown-menu">
							<@shiro.hasPermission name="/order/orderCRUD.shtmlget">
								<li><a href="${basePath}/order/orderCRUD/list.shtml">订单列表</a></li>
							</@shiro.hasPermission>
				...
				<li>
					<a class="dropdown-toggle" href="${basePath}/member/list.shtml" target="_blank">
